...
if(init.innerText == ""){
    alert("This web was designed by John and is protected under Copy Rigth Licences if you want to use it you must keep the proper rigths");
